...
/**
 * Implementación de Nota de Crédito para El Salvador
 * 
 * Genera documentos tipo 05 (Nota de Crédito) según especificaciones de MH El Salvador
 * 
 * @package App\Services\FacturacionElectronica\Implementations\ElSalvador
 */
class ElSalvadorNotaCredito extends ElSalvadorFE
{
    ...
    /**
     * Genera el DTE de tipo Nota de Crédito (05)
     * 
    ...
    /**
     * Genera la estructura completa de la nota de crédito
     * 
     * @return array
     */
    protected function generarNotaCredito(): array
    {
        $tributos = NULL;
    ...
    protected function generarDTEAnulado(array $dte, $documento): array
    {
        ...
        // Para Nota de Crédito, el receptor tiene estructura similar a CCF
        $tipo_documento = '36';
