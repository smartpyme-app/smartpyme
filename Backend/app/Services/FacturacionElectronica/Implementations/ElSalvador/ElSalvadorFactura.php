...
/**
 * Implementación de Factura Electrónica para El Salvador
 * 
 * Genera documentos tipo 01 (Factura) según especificaciones de MH El Salvador
 * 
 * @package App\Services\FacturacionElectronica\Implementations\ElSalvador
 */
class ElSalvadorFactura extends ElSalvadorFE
{
    protected $venta;
    protected $sucursal;
    ...
    /**
     * Genera el DTE de tipo Factura (01)
     * 
    ...
    /**
     * Genera la estructura completa de la factura
     * 
     * @return array
     */
    ...
    protected function receptor(): array
    {
        ...
        return [
            "tipoDocumento" => $this->venta->cliente->tipo_documento,
