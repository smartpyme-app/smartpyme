...
class LibrosIvaSvController extends Controller
{
    ...
    private function assertElSalvador(): void
    {
        if ($this->libroIvaPaisResolver->tipo() !== LibroIvaPaisResolver::TIPO_SV) {
            abort(403, 'Esta operación solo está disponible para empresas de El Salvador.');
        }
    }
