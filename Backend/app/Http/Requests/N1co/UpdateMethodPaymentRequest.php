...
class UpdateMethodPaymentRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'customer.phoneNumber.required' => 'El teléfono del cliente es requerido.',
            ...
            'billingInfo.countryCode.required' => 'El código de país es requerido.',
            'billingInfo.stateCode.required' => 'El código de estado es requerido.',
            'billingInfo.zipCode.required' => 'El código postal es requerido.',
        ];
    }
}
