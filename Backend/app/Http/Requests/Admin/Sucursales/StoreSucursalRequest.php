...
class StoreSucursalRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'cod_departamento' => 'sometimes|nullable|string|max:10',
            'cod_municipio' => 'sometimes|nullable|string|max:10',
            'cod_distrito' => 'sometimes|nullable|string|max:10',
    ...
    public function messages(): array
    {
        return [
            ...
            'distrito.max' => 'El distrito no puede exceder 255 caracteres.',
