...
class VentasComprasPorMarcaProveedorSheet1 implements FromCollection, WithHeadings, WithMapping, WithTitle, WithStyles, ShouldAutoSize, WithColumnFormatting
{
    public $fechaInicio;
    public $fechaFin;
    public $id_empresa;
    ...
    {
        return 'Ventas y Compras por Marca y Proveedor';
    }
    ...
    public function collection()
    {
        ...
        // Nota: Las ventas no tienen proveedor directo, pero podemos obtenerlo del producto
