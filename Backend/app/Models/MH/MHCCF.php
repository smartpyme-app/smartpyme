...
class MHCCF extends Model
{
    ...
    public function generarDTE($venta){
        ...
        // Total en letras = monto a pagar (totalPagar)
        ...
        return 
            [
               ...
               "resumen" => [
                  ...
                  "montoTotalOperacion" => floatval(number_format($this->venta->total - $sumNoGravadoCuerpo + $this->venta->iva_retenido + $this->venta->renta_retenida, 2, '.', '')),
