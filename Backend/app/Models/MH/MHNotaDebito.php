...
class MHNotaDebito extends Model
{
        ...
        return 
            [
                ...
                "resumen" => [
                  ...
                  "reteRenta" => 0,
                  "montoTotalOperacion" => floatval(number_format($this->devolucion->total - $sumNoGravadoCuerpo + $this->devolucion->iva_retenido, 2, '.', '')),
    ...
    protected function detalles(){
        ...
        foreach ($this->devolucion->detalles as $index => $detalle) {
            ...
            $numDoc = $this->devolucion->venta->dte['identificacion']['codigoGeneracion'];
