...
Route::group(['middleware' => ['jwt.auth']], function () {
	...
	require base_path('routes/modulos/ventas/creditos-clientes.php');
	...
	// Restaurante
	require base_path('routes/modulos/restaurante.php');
    ...
    require base_path('routes/modulos/finanzas/prestamos-empresa.php');
