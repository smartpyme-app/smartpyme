...
use App\Http\Controllers\Api\Contabilidad\Reportes\GenerarReportesController;
    ...
    Route::get('/reportes/diario/auxiliar/{startDate}/{endDate}/{type}',        [GenerarReportesController::class, 'generarRepLibroDiarioAux']); //genera el libro diario auxiliar solamente como temporal
