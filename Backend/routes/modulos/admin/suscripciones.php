...
use Illuminate\Support\Facades\Route;
    ...
    Route::post('/suscripcion/asignar-cliente', [SuscripcionesController::class, 'asignarCliente']);
    Route::post('/suscripcion/tipo-factura', [SuscripcionesController::class, 'actualizarTipoFactura']);
    Route::post('/suscripcion/frecuencia-pago', [SuscripcionesController::class, 'actualizarFrecuenciaPago']);
