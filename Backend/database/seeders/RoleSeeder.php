...
class RoleSeeder extends Seeder
{
    public function run()
    {
        ...
        $contadorSuperior->givePermissionTo([
            ...
            config('permissions.PERMISSION_CONTABILIDAD.bancos.ver'),
            config('permissions.PERMISSION_CONTABILIDAD.bancos.crear'),
            config('permissions.PERMISSION_CONTABILIDAD.bancos.editar'),
            config('permissions.PERMISSION_CONTABILIDAD.bancos.eliminar'),
            ...
            config('permissions.PERMISSION_PLANILLA.comisiones.ver'),
            config('permissions.PERMISSION_PLANILLA.comisiones.crear'),
            config('permissions.PERMISSION_PLANILLA.comisiones.editar'),
            config('permissions.PERMISSION_PLANILLA.comisiones.eliminar'),
            config('permissions.PERMISSION_PLANILLA.bonos.ver'),
            config('permissions.PERMISSION_PLANILLA.bonos.crear'),
            config('permissions.PERMISSION_PLANILLA.bonos.editar'),
            config('permissions.PERMISSION_PLANILLA.bonos.eliminar'),
            config('permissions.PERMISSION_PLANILLA.incentivos.ver'),
            config('permissions.PERMISSION_PLANILLA.incentivos.crear'),
            config('permissions.PERMISSION_PLANILLA.incentivos.editar'),
            config('permissions.PERMISSION_PLANILLA.incentivos.eliminar'),
            // Consignas de ventas y de compras / Restaurante / Pedidos
            config('permissions.PERMISSION_VENTAS.consignas.ver'),
            config('permissions.PERMISSION_VENTAS.consignas.crear'),
            config('permissions.PERMISSION_VENTAS.consignas.editar'),
            config('permissions.PERMISSION_VENTAS.consignas.eliminar'),
            config('permissions.PERMISSION_COMPRAS.consignas.ver'),
            config('permissions.PERMISSION_COMPRAS.consignas.crear'),
            config('permissions.PERMISSION_COMPRAS.consignas.editar'),
            config('permissions.PERMISSION_COMPRAS.consignas.eliminar'),
            config('permissions.PERMISSION_ADMINISTRACION.departamentos.ver'),
            config('permissions.PERMISSION_ADMINISTRACION.departamentos.crear'),
            config('permissions.PERMISSION_ADMINISTRACION.departamentos.editar'),
            config('permissions.PERMISSION_ADMINISTRACION.departamentos.eliminar'),
            config('permissions.PERMISSION_ADMINISTRACION.areas.ver'),
            config('permissions.PERMISSION_ADMINISTRACION.areas.crear'),
            config('permissions.PERMISSION_ADMINISTRACION.areas.editar'),
            config('permissions.PERMISSION_ADMINISTRACION.areas.eliminar'),
            config('permissions.PERMISSION_RESTAURANTE.ver'),
            config('permissions.PERMISSION_RESTAURANTE.crear'),
            config('permissions.PERMISSION_RESTAURANTE.editar'),
            config('permissions.PERMISSION_RESTAURANTE.eliminar'),
            config('permissions.PERMISSION_PEDIDOS.ver'),
