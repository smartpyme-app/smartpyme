...
class RoleSeeder extends Seeder
{
    public function run()
    {
        ...
        $contadorSuperior->givePermissionTo([
            ...
            // Consignas / Restaurante / Pedidos
            config('permissions.PERMISSION_CONSIGNAS.ver'),
            config('permissions.PERMISSION_CONSIGNAS.crear'),
            config('permissions.PERMISSION_CONSIGNAS.editar'),
            config('permissions.PERMISSION_CONSIGNAS.eliminar'),
