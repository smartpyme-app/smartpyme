...
class ComisionPeriodoServiceTest extends TestCase
{
    ...
    public function test_ajuste_crea_mes_posterior_a_pagado_sin_siguiente_abierto(): void
    {
        $periodoPagado = (object) [
            'id' => 1,
            'id_empresa' => 1,
        ...
        $this->assertNotNull($periodoCreado);
        $this->assertSame(3, $result->id);
        $this->assertSame('2026-07-01', $result->fecha_inicio);
        $this->assertNotSame('2026-06-01', $result->fecha_inicio);
    }
