    ...
    <section id="factura">
        <table id="header">
            <tbody style="border: 0px;">
                <tr>
                    ...
                    <td><h1 style="text-align: right; font-size: 1.4em;">NOTA DE DÉBITO</h1></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <h1 style="color: red; font-size: 1.2em;">000-002-07- {{ str_pad($venta->correlativo, 8, '0', STR_PAD_LEFT)}}</h1>
                        <br>
        ...
        <table id="productos">
            ...
            <tfoot style="display: table-row-group; page-break-inside: avoid;">
                ...
                <tr>
                    <td colspan="3">RANGO 000-002-07-00000201 / 000-002-07-00000220</td>
