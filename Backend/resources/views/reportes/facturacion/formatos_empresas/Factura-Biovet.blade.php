...
<head>
    ...
    <style>
        ...
        *{ font-size: 14px; margin: 0; padding: 0;}
        ...
        #factura{
            background-image: url('/img/FBiovet.jpg'); background-size: 100%; 
...
/*            overflow: hidden; white-space: pre;*/
        ...
        #cliente        {top: 5cm; left: 3cm; width: 9cm;}
        #direccion      {top: 5.8cm; left: 3cm; }

        #fecha          {top: 5cm; left: 16.5cm; }
        #nit            {top: 6.5cm; left: 2.5cm; }
        ...
        .sujetas{ width: 2cm; text-align: center;}
        .exentas{ width: 2cm; text-align: center;}
        ...
        #suma       {top: 10.5cm; left: 18.5cm; width: 2cm; text-align: right;}
        #no_sujeta  {top: 11cm; left: 18.5cm; width: 2cm; text-align: right;}
        #exenta     {top: 12cm; left: 18.5cm; width: 2cm; text-align: right;}
        #total      {top: 13.7cm; left: 18.5cm; width: 2cm; text-align: right;}
