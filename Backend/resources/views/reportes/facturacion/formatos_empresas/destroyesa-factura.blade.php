...
<head>
    ...
    <title>Destroyesa {{$venta[0]->documento}} - {{$venta[0]->correlativo}}</title>
    <style>
...
/*            overflow: hidden; white-space: pre;*/
        ...
        #suma       {top: 9.5cm; left: 8.7cm; width: 1cm; text-align: right;}
        #iva        {top: 10cm; left: 8.7cm; width: 1cm; text-align: right;}
        ...
        #total      {top: 11.7cm; left: 8.7cm; width: 1cm; text-align: right;}
