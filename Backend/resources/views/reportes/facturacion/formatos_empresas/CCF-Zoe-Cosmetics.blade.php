...
/*            border: 1px solid red;*/
        ...
        #direccion      {top: 5.5cm; left: 2.5cm; width: 7cm;}
        #municipio      {top: 6.8cm; left: 3cm; width: 5cm;}
        #departamento   {top: 7.5cm; left: 3cm; width: 5cm;}
        
        #fecha          {top: 4.5cm; left: 13cm; }
        #nrc            {top: 5cm; left: 13.5cm;}
        #nit            {top: 5.7cm; left: 13.2cm; }
        #giro            {top: 6.3cm; left: 13cm;}
        #condicion      {top: 7cm; left: 14cm; }

        table   {position: absolute; top: 9.5cm; left: 0.2cm; text-align: left; border-collapse: collapse; width: 19.5cm;}
        ...
        #suma       {top: 19.5cm; left: 18.5cm; width: 1.5cm; text-align: right;}
        #iva        {top: 20.1cm; left: 18.5cm; width: 1.5cm; text-align: right;}
        #iva_retenido  {top: 20.7cm; left: 18.5cm; width: 1.5cm; text-align: right;}
        #sub_total  {top: 21.3cm; left: 18.5cm; width: 1.5cm; text-align: right;}
        #no_sujeta  {top: 21.9cm; left: 18.5cm; width: 1.5cm; text-align: right;}
        #exenta     {top: 22.5cm; left: 18.5cm; width: 1.5cm; text-align: right;}
        #cuenta_a_terceros {top: 23.1cm; left: 18.5cm; width: 1.5cm; text-align: right;}
        #total      {top: 23.6cm; left: 18.5cm; width: 1.5cm; text-align: right;}
