...
<head>
    ...
    <style>
        ...
        *{ font-size: 14px; margin: 0; padding: 0;}
        ...
        #cliente        {top: 4.5cm; left: 2.5cm; width: 9cm;}
        #fecha          {top: 4.5cm; left: 10cm; }
        #direccion      {top: 5cm; left: 2.5cm; width: 9cm;}
        #nit            {top: 5cm; left: 10.5cm; }
        #condicion      {top: 5.5cm; left: 12.3cm; }


        table   {position: absolute; top: 7cm; left: 1cm; text-align: left; border-collapse: collapse; }
        table td{height: 0.6cm; text-align: left;}

        .cantidad{ width: 1.2cm; text-align: center;}
        .producto{ width: 6.4cm; text-align: left;}
        ...
        #letras     {top: 16.5cm; left: 2cm; width: 5cm; word-break: break-all; white-space: normal;}
        #correlativo{top: 17.5cm; left: 2cm;; width: 9cm;;}

        #suma       {top: 16.5cm; left: 10.8cm; width: 2cm; text-align: right;}
        #no_sujeta  {top: 17cm; left: 10.8cm; width: 2cm; text-align: right;}
        #exenta     {top: 17.5cm; left: 10.8cm; width: 2cm; text-align: right;}
        #total      {top: 19.3cm; left: 10.8cm; width: 2cm; text-align: right;}
