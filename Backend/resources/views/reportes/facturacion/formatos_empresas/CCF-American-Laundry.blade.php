...
<html>
<head>
    <title> American Laundry {{$venta->nombre_documento}} - {{$venta->correlativo}}</title>
    <style>
...
/*            border: 1px solid red;*/
        ...
        #giro           {top: 6cm; left: 2cm; width: 6.7cm; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;}
        #condicion      {top: 6.5cm; left: 4.5cm; }
        
        #fecha          {top: 3.5cm; left: 9.5cm; }
        #nit            {top: 5cm; left: 9.5cm;}
        #ncr            {top: 5.5cm; left: 9.5cm; }
        #departamento   {top: 6cm; left: 10.5cm; }


        table   {position: absolute; top: 8.5cm; left: 0.5cm; text-align: left; border-collapse: collapse; }
        ...
        #letras     {top: 16cm; font-size: 12px; left: 2.2cm; width: 5cm; word-break: break-all; white-space: normal;}

        #suma       {top: 16cm; left: 11cm; width: 2cm; text-align: right;}
        #iva        {top: 16.5cm; left: 11cm; width: 2cm; text-align: right;}
        #subtotal    {top: 17.1cm; left: 11cm; width: 2cm; text-align: right;}
        #renta_retenida     {top: 17.6cm; left: 11cm; width: 2cm; text-align: right;}
        #iva_retenido     {top: 18.2cm; left: 11cm; width: 2cm; text-align: right;}
        #no_sujeta     {top: 18.5cm; left: 11cm; width: 2cm; text-align: right;}
        #exenta     {top: 19cm; left: 11cm; width: 2cm; text-align: right;}
        #total      {top: 19.4cm; left: 11cm; width: 2cm; text-align: right;}
...
<section id="factura">
    ...
    <div id="totales">
        ...
        <p id="subtotal"> $ {{ number_format($venta->total + $venta->iva_retenido + $venta->renta_retenida, 2) }}</p>
