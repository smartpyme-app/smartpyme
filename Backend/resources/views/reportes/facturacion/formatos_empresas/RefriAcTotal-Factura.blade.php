...
<head>
    ...
    <title>Refrigeración y aire acondicionado TOTAL{{$venta->nombre_documento}} - {{$venta->correlativo}}</title>
    <style>

        *{ font-size: 15px; margin: 0; padding: 0;}
        html, body{
            width: 21.3cm; height: 27.8cm;
            font-family: serif;
        ...
        table   {position: absolute; top: 9cm; left: 1cm; text-align: left; border-collapse: collapse; }
...
<body>
{{--<section id="factura" style="border:1px solid #ffffff00;background-image: url('C:\Users\josep\Documents\smartpyme\smartpyme\Backend\public\img\refrgAcTotal-Factura.jpg'); background-repeat: no-repeat; background-size: 100% 100%; height: 29cm; width: 22cm;">--}}
<section id="factura">
    <div id="header">
