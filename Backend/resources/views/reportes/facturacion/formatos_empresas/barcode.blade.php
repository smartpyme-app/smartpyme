<center>
    {{ $codigo }}
    <br>
    {!! '<img id="barcode" src="data:image/png;base64,' . DNS1D::getBarcodePNG($codigo, 'C39+', 2, 50) . '" alt="barcode"   />' !!}
    <br><br>
...
<center>
    {{ $codigo }}
    <br>
    {!! '<img id="qrcode" src="data:image/png;base64,' . DNS2D::getBarcodePNG($codigo, 'QRCODE', 10, 10) . '" alt="barcode"   />' !!}
    <br><br>
