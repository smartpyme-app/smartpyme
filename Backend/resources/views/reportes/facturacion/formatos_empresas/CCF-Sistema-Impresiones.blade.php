...
<head>
    ...
    <style>
        ...
        *{ font-size: 10px; margin: 0; padding: 0;}
        ...
        #fecha          {top: 5.3cm; left: 14.5cm; }
        #ncr           {top: 5.6cm; left: 14.5cm; }
        #nit            {top: 5.9cm; left: 14.5cm; }
        #giro            {top: 6.2cm; left: 14.5cm; }

        #cliente        {top: 5.3cm; left: 2.5cm; width: 9cm;}
        #direccion      {top: 5.6cm; left: 2.5cm; width: 9cm;}
        #municipio      {top: 5.9cm; left: 2.5cm; width: 9cm;}
        #condicion      {top: 6.2cm; left: 6.5cm; }
        #departamento      {top: 6.5cm; left: 2.5cm; width: 9cm;}


        table   {position: absolute; top: 10cm; left: 0.5cm; text-align: left; border-collapse: collapse; }
        ...
        #letras     {top: 22.5cm; left: 2cm; width: 9cm; word-break: break-all; white-space: normal;}
        #correlativo{top: 17cm; left: 2cm;; width: 9cm;;}

        #suma       {top: 22cm; left: 18cm; width: 2cm; text-align: right;}
        #iva        {top: 22.8cm; left: 18cm; width: 2cm; text-align: right;}
        #subtotal    {top: 23.3cm; left: 18cm; width: 2cm; text-align: right;}
