...
/*            border: 1px solid red;*/
        ...
        #fecha          {top: 5cm; left: 9cm; }
        #cliente        {top: 5.5cm; left: 2.5cm; width: 9cm;}
        #direccion      {top: 6cm; left: 2.5cm; width: 9cm;}
        #condicion      {top: 6.5cm; left: 10.3cm; }
        #nit            {top: 6.5cm; left: 2cm; }


        table   {position: absolute; top: 8cm; left: 0.6cm; text-align: left; border-collapse: collapse; }
        ...
        #suma       {top: 15.5cm; left: 10.4cm; width: 2cm; text-align: right;}
        #no_sujeta  {top: 16.2cm; left: 10.4cm; width: 2cm; text-align: right;}
        #exenta     {top: 17cm; left: 10.4cm; width: 2cm; text-align: right;}
        #total      {top: 18.5cm; left: 10.4cm; width: 2cm; text-align: right;}
