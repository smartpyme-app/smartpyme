...
/*            border: 1px solid red;*/   
        ...
        #cliente        {top: 4.1cm; left: 2.5cm; width: 9cm;}
        #direccion      {top: 4.8cm; left: 2.7cm; width: 9cm;}
        #condicion      {top: 5.4cm; left: 3cm; }
/*        #departamento      {top: 3.9cm; left: 2cm; width: 9cm;}*/


        table   {position: absolute; top: 7cm; left: 0.7cm; text-align: left; border-collapse: collapse; }
        ...
        #letras     {top: 16.7cm; font-size: 10px; left: 2.5cm; width: 5cm; word-break: break-all; white-space: normal;}

        #suma       {top: 16.7cm; left: 11cm; width: 2cm; text-align: right;}
        #subtotal    {top: 17.4cm; left: 11cm; width: 2cm; text-align: right;}
        #no_sujeta     {top: 18.1cm; left: 11cm; width: 2cm; text-align: right;}
        #exenta     {top: 18.8cm; left: 11cm; width: 2cm; text-align: right;}
        #total      {top: 19.7cm; left: 11cm; width: 2cm; text-align: right;}
