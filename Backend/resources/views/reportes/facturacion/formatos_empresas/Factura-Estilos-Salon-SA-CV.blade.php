...
<html>
<head>
    <title>Estilos Salon SA de CV {{$venta->nombre_documento}} - {{$venta->correlativo}}</title>
    <style>
...
/*            border: 1px solid red;*/
        ...
        #fecha          {top: 5cm; left: 6.5cm; }

        #cliente        {top: 5.5cm; left: 1.8cm; width: 9cm;}
        #direccion      {top: 6cm; left: 1.8cm; width: 9cm;}
        #nit            {top: 6.5cm; left: 1.8cm; }


        table   {width: 9cm; position: absolute; top: 7.5cm; left: 0.3cm; text-align: left; border-collapse: collapse; width: 9.2cm;}
        ...
        .sujetas{ width: 0.6cm; text-align: center;}
        .exentas{ width: 0.6cm; text-align: center;}
        ...
        #suma       {top: 10.3cm; left: 7.4cm; width: 2cm; text-align: right;}
        #iva_retenido  {top: 10.7cm; left: 7.4cm; width: 2cm; text-align: right;}
        #sub_total  {top: 11.1cm; left: 7.4cm; width: 2cm; text-align: right;}
        #no_sujeta  {top: 11.5cm; left: 7.4cm; width: 2cm; text-align: right;}
        #exenta     {top: 11.9cm; left: 7.4cm; width: 2cm; text-align: right;}
        #total      {top: 12.3cm; left: 7.4cm; width: 2cm; text-align: right;}
