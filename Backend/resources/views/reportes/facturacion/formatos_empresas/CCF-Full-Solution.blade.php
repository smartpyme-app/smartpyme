...
<head>
    ...
    <style>
        ...
        *{ font-size: 12px; margin: 0; padding: 0;}
        ...
        #fecha          {top: 3cm; left: 12cm; }
        #nit            {top: 3.5cm; left: 12cm; }
        #nrc            {top: 4cm; left: 12cm }
        #giro            {top: 4.5cm; left: 12cm }
        ...
        #letras     {top: 14cm; left: 2cm; width: 9cm; word-break: break-all; white-space: normal;}

        #suma       {top: 14cm; left: 18cm; width: 2cm; text-align: right;}
        #iva        {top: 14.5cm; left: 18cm; width: 2cm; text-align: right;}
        #subtotal   {top: 15cm; left: 18cm; width: 2cm; text-align: right;}
        #no_sujeta  {top: 15.5cm; left: 18cm; width: 2cm; text-align: right;}
        #exenta     {top: 15.5cm; left: 18cm; width: 2cm; text-align: right;}
        #total      {top: 16cm; left: 18cm; width: 2cm; text-align: right;}
