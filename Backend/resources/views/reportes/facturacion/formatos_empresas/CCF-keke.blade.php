...
<head>
    ...
    <style>
        ...
        *{ font-size: 10px; margin: 0; padding: 0;}
        ...
        #fecha          {top: 3.6cm; left: 14.5cm; }
        #ncr           {top: 4.1cm; left: 14.5cm; }
        #nit            {top: 4.6cm; left: 14.5cm; }
        #giro            {top: 5.5cm; left: 14.5cm; }

        #cliente        {top: 3.6cm; left: 2.5cm; width: 9cm;}
        #direccion      {top: 4.1cm; left: 2.5cm; width: 9cm;}
        #condicion      {top: 5.4cm; left: 6.5cm; }
        #departamento      {top: 4.6cm; left: 2.5cm; width: 9cm;}


        table   {position: absolute; top: 6cm; left: 0.2cm; text-align: left; border-collapse: collapse; }
        ...
        #letras     {top: 12.2cm; left: 2cm; width: 9cm; word-break: break-all; white-space: normal;}
        #correlativo{top: 17cm; left: 2cm;; width: 9cm;;}

        #suma       {top: 12.1cm; left: 18cm; width: 2cm; text-align: right;}
        #iva        {top: 12.6cm; left: 18cm; width: 2cm; text-align: right;}
        #subtotal    {top: 13.1cm; left: 18cm; width: 2cm; text-align: right;}
        #no_sujeta  {top: 13.6cm; left: 18cm; width: 2cm; text-align: right;}
        ...
        #total      {top: 15.1cm; left: 18cm; width: 2cm; text-align: right;}
