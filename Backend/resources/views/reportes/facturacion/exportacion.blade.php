...
<head>
	...
	<title>Factura de Exportación</title>
	<style>
...
/*            height: 0.5cm;*/
        ...
        #cliente        {position: absolute; top: {{ number_format($venta->pos_cliente_y, 1) }}cm; left: {{ number_format($venta->pos_cliente_x, 1) }}cm; width: 9cm; text-wrap: nowrap; overflow: hidden;}
        #direccion      {position: absolute; top: {{ number_format($venta->pos_direccion_y, 1) }}cm; left: {{ number_format($venta->pos_direccion_x, 1) }}cm; width: 9cm; overflow: hidden;}
        ...
        #iva        {position: absolute; top: {{ number_format($venta->pos_sumas_y + ($venta->pos_detalles_linea_alto * 1), 1) }}cm; left: {{ number_format($venta->pos_sumas_x, 1) }}cm; width: {{ number_format($venta->pos_detalles_gravadas, 1) }}cm; text-align: right;}
        #subtotal   {position: absolute; top: {{ number_format($venta->pos_sumas_y + ($venta->pos_detalles_linea_alto * 3), 1)}}cm; left: {{ number_format($venta->pos_sumas_x, 1) }}cm; width: {{ number_format($venta->pos_detalles_gravadas, 1) }}cm; text-align: right;}
        #iva_percibido      {position: absolute; top: {{ number_format($venta->pos_sumas_y + ($venta->pos_detalles_linea_alto * 4), 1) }}cm; left: {{ number_format($venta->pos_sumas_x, 1) }}cm; width: {{ number_format($venta->pos_detalles_gravadas, 1) }}cm; text-align: right;}
        #iva_retenido      {position: absolute; top: {{ number_format($venta->pos_sumas_y + ($venta->pos_detalles_linea_alto * 5), 1) }}cm; left: {{ number_format($venta->pos_sumas_x, 1) }}cm; width: {{ number_format($venta->pos_detalles_gravadas, 1) }}cm; text-align: right;}
        #no_sujeta      {position: absolute; top: {{ number_format($venta->pos_sumas_y + ($venta->pos_detalles_linea_alto * 6), 1) }}cm; left: {{ number_format($venta->pos_sumas_x, 1) }}cm; width: {{ number_format($venta->pos_detalles_gravadas, 1) }}cm; text-align: right;}
        #exenta      {position: absolute; top: {{ number_format($venta->pos_sumas_y + ($venta->pos_detalles_linea_alto * 7), 1) }}cm; left: {{ number_format($venta->pos_sumas_x, 1) }}cm; width: {{ number_format($venta->pos_detalles_gravadas, 1) }}cm; text-align: right;}
        #total      {position: absolute; top: {{ number_format($venta->pos_total_y, 1) }}cm; left: {{ number_format($venta->pos_total_x, 1) }}cm; width: {{ number_format($venta->pos_detalles_gravadas, 1) }}cm; text-align: right;}
	...
	<section style="border:1px solid #ffffff00; background-image: url('/img/credito.jpg'); background-repeat: no-repeat; background-size: 100% 100%; height: 14.2cm; position: relative;">
		...
		<table>
			...
			<tr>
				...
				<td class="precio">		${{number_format($detalle->precio + $detalle->iva , 2) }}</td>
				...
				<td class="gravadas">	@if($detalle->total) ${{ number_format($detalle->total, 2) }} @endif</th>
			</tr>
