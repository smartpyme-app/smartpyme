...
/*            height: 0.5cm;*/
        ...
        #cliente        {position: absolute; top: {{ number_format($venta->pos_cliente_y, 1) }}cm; left: {{ number_format($venta->pos_cliente_x, 1) }}cm; width: 8cm; text-wrap: nowrap; overflow: hidden;}
        #direccion      {position: absolute; top: {{ number_format($venta->pos_direccion_y, 1) }}cm; left: {{ number_format($venta->pos_direccion_x, 1) }}cm; width: 7.5cm; text-wrap: nowrap; overflow: hidden;}
        ...
        #suma        {position: absolute; top: 11cm; left: {{ number_format($venta->pos_sumas_x, 1)}}cm; width: {{ number_format($venta->pos_detalles_gravadas, 1) }}cm; text-align: right;}
        #subtotal    {position: absolute; top: 11.5cm; left: {{ number_format($venta->pos_sumas_x, 1) }}cm; width: {{ number_format($venta->pos_detalles_gravadas, 1) }}cm; text-align: right;}
