...
<style>
    ...
    *{ font-family: sans-serif; color: #333; margin:0px; padding: 0px;}
    ...
    .table td, .table th { padding: 5px 10px; font-size: 14px; text-align: left; vertical-align: top;}
    .table-bordered td, .table-bordered th { border: 0.5px solid gray; }
...
<body>
    ...
    <div class="header text-center">
        ...
        {{-- <h2 class="text-center"> Carta de porte N° {{ $flete->venta()->pluck('correlativo')->first() }} </h2> --}}
        <h2 class="text-center"> Carta de porte N° {{ $flete->id }} </h2>
    </div>
    <div class="footer">
