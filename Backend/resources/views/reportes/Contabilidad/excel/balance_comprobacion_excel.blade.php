...
<table>
    <thead>
    <tr>
        <th colspan="7" style="text-align: center; font-size: 16px;"><strong>Balance de Comprobación</strong></th>
    </tr>
    <tr>
        <th colspan="7" style="text-align: center; font-size: 16px;"><strong>Empresa: {{ $empresa->nombre }}</strong></th>
    </tr>
    <tr>
        <th colspan="7" style="text-align: center; font-size: 16px;"><strong>Período: {{ $month_name }} - {{ $year }}</strong></th>
    </tr>
    <tr>
        <th colspan="7" style="text-align: center; font-size: 16px;"><strong>Todos los Centros de Costos</strong></th>
    </tr>
    <tr>
        <th colspan="7" style="text-align: center; font-size: 16px;"><strong>Valores expresados en US dólares</strong></th>
    </tr>
    <tr>
        <th colspan="7" style="text-align: center; font-size: 16px;"><strong>Activos y Gastos</strong></th>
    </tr>
    <tr></tr>
    <tr>
    ...
    @if(isset($totales))
        ...
        <tr style="background-color: #fff3cd;">
            <td colspan="7" style="text-align: center; font-weight: bold;">NOTA: Los totales solo incluyen cuentas padre (nivel = 0)</td>
        </tr>
        <tr style="background-color: #fff3cd;">
            <td colspan="7" style="text-align: center; font-style: italic;">Las cuentas padre (P) consolidan los valores de sus subcuentas</td>
        </tr>
        <tr></tr>
