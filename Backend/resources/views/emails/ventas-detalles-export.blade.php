    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td style="text-align: center; padding-top: 10px; padding-bottom: 15px;">
                <h3 style="color: #4CAF50; margin: 0;">✅ Reporte de Detalles de Ventas Generado</h3>
            </td>
        </tr>
        <tr>
            <td style="padding: 50px 25px; background-color: #e8f5e8; border-radius: 30px; margin: 15px 0px; border: 2px solid #4CAF50;">
                ...
                <p style="margin: 15px 0px;">Se ha generado exitosamente el reporte de detalles de ventas totales.</p>
                ...
                <p style="margin: 15px 0px;">El archivo contiene todos los detalles de las ventas con información completa de productos, clientes, vendedores y totales.</p>
                
                <h4 style="color: #2E7D32; margin: 20px 0 10px 0;">📋 Contenido del Reporte:</h4>
                <ul style="margin: 0; padding-left: 20px;">
                    <li>Fecha de la venta</li>
                    <li>Información del cliente (nombre, teléfono, DUI, NIT)</li>
                    <li>Detalles del producto (nombre, código, marca, categoría)</li>
                    <li>Información del documento y correlativo</li>
                    <li>Cantidades, precios, descuentos e IVA</li>
                    <li>Utilidad y totales</li>
                    <li>Información del vendedor y sucursal</li>
                </ul>
