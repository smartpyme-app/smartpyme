    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td style="text-align: center; padding-top: 10px; padding-bottom: 15px;">
                <h3 style="color: #f44336; margin: 0;">⚠️ Error al Generar Kardex</h3>
            </td>
        </tr>
        <tr>
            <td style="padding: 50px 25px; background-color: #ffebee; border-radius: 30px; margin: 15px 0px; border: 2px solid #f44336;">
                ...
                <p style="margin: 15px 0px;">Ha ocurrido un error al intentar generar el kardex completo de su empresa.</p>
                ...
                <ul style="margin: 0; padding-left: 20px;">
                    <li>Intentar generar el kardex nuevamente desde el sistema</li>
                    <li>Verificar que tenga suficientes productos en su inventario</li>
