    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td style="text-align: center; padding-top: 10px; padding-bottom: 15px;">
                <h3 style="color: #4CAF50; margin: 0;">✅ Kardex Completo Generado</h3>
            </td>
        </tr>
        <tr>
            <td style="padding: 50px 25px; background-color: #e8f5e8; border-radius: 30px; margin: 15px 0px; border: 2px solid #4CAF50;">
                <h3 style="margin: 0px; color: #2E7D32;">¡Kardex Listo!</h3>
                
                <p style="margin: 15px 0px;">Se ha generado exitosamente el kardex completo de todos los productos de su empresa.</p>
                ...
                <p style="margin: 15px 0px;">El archivo contiene todos los movimientos de inventario (entradas, salidas, ajustes, traslados, etc.) de todos los productos de su empresa.</p>
                
                <h4 style="color: #2E7D32; margin: 20px 0 10px 0;">📋 Contenido del Kardex:</h4>
                <ul style="margin: 0; padding-left: 20px;">
                    <li>Fecha y hora de cada movimiento</li>
                    <li>Información del producto (nombre y código)</li>
                    <li>Bodega y sucursal</li>
                    <li>Tipo de movimiento</li>
                    <li>Detalle del movimiento</li>
                    <li>Cantidades y stocks</li>
