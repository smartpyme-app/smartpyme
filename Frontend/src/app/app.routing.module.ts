...
const routes: Routes = [
  ...
  // Inventario
  {
    ...
    canActivate: [AuthGuard],
    loadChildren: () =>
      import('./views/inventario/inventario.module').then(
  ...
  // Paquetes
  {
    ...
    canActivate: [AuthGuard],
    loadChildren: () =>
      import('./views/paquetes/paquetes.module').then((m) => m.PaquetesModule),
  },
  ...
  // Organizaciones Admin
  {
    ...
    canActivate: [AuthGuard],
    loadChildren: () =>
      import('./views/organizaciones-admin/organizaciones-admin.module').then(
        (m) => m.OrganizacionesAdminModule
      ),
  },
