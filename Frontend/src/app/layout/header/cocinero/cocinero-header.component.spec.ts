...
import { CocineroHeaderComponent } from './cocinero-header.component';

describe('CocineroHeaderComponent', () => {
  beforeEach(async(() => {
  ...
  it('should create the app', () => {
    const fixture = TestBed.createComponent(CocineroHeaderComponent);
