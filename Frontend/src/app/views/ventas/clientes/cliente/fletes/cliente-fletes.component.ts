...
@Component({
  selector: 'app-cliente-fletes',
  templateUrl: './cliente-fletes.component.html',
})
export class ClienteFletesComponent implements OnInit {
    ...
    public loadAll() {
        this.loading = true;
        this.apiService.getAll('cliente/fletes/' + this.route.snapshot.paramMap.get('id')!).subscribe(fletes => { 
            this.fletes = fletes;
