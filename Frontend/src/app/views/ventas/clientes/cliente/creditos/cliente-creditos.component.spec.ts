...
import { ClienteCreditosComponent } from './cliente-creditos.component';

describe('ClienteCreditosComponent', () => {
  beforeEach(async(() => {
  ...
  it('should create the app', () => {
    const fixture = TestBed.createComponent(ClienteCreditosComponent);
