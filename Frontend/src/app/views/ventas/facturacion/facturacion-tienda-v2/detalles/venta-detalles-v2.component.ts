...
export class VentaDetallesV2Component implements OnInit, OnDestroy {
    ...
    private aplicarTipoGravado(detalle: any) {
        ...
        if (tipo === 'exonerada') {
            ...
            detalle.total = (parseFloat(String(detalle.sub_total)) - parseFloat(detalle.descuento || 0)).toFixed(4);
