...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'orden-de-compra/crear', component: OrdenCompraFormComponent, title: 'Orden de compra' },
      { path: 'orden-de-compra/:id', component: OrdenCompraFormComponent, title: 'Orden de compra' },
