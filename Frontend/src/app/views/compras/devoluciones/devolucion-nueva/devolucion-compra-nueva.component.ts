...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, PipesModule, RouterModule, FormsModule, DevolucionCompraDetallesComponent, CurrencyPipe],
    providers: [SumPipe],
...
export class DevolucionCompraNuevaComponent extends BaseModalComponent implements OnInit {
    ...
    // Devolución
        ...
        public onDevolucion() {
            ...
            this.saving = true;
            this.apiService.store('devolucion-compra', this.devolucion)
                .pipe(this.untilDestroyed())
