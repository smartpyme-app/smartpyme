...
import { FlotaDocumentosComponent } from './flota-documentos.component';

describe('FlotaDocumentosComponent', () => {
  beforeEach(async(() => {
  ...
  it('should create the app', () => {
    const fixture = TestBed.createComponent(FlotaDocumentosComponent);
