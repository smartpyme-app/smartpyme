...
import { FlotaInformacionComponent } from './flota-informacion.component';

describe('FlotaInformacionComponent', () => {
  beforeEach(async(() => {
  ...
  it('should create the app', () => {
    const fixture = TestBed.createComponent(FlotaInformacionComponent);
