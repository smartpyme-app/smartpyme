...
import { EmpleadoFletesComponent } from './empleado-fletes.component';

describe('EmpleadoFletesComponent', () => {
  beforeEach(async(() => {
  ...
  it('should create the app', () => {
    const fixture = TestBed.createComponent(EmpleadoFletesComponent);
