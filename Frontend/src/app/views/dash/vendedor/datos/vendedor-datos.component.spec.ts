...
import { VendedorDatosComponent } from './vendedor-datos.component';

describe('VendedorDatosComponent', () => {
  beforeEach(async(() => {
  ...
  it('should create the app', () => {
    const fixture = TestBed.createComponent(VendedorDatosComponent);
